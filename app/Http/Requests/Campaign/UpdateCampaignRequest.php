...
class UpdateCampaignRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'year' => 'sometimes|required|integer|min:1900|max:' . (int) date('Y') + 10,
    ...
    public function messages(): array
    {
        return [
            ...
            'name.string' => 'Campaign name must be a string.',
            'name.max' => 'Campaign name must not exceed 150 characters.',
