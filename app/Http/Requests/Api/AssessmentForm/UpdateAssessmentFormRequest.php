...
class UpdateAssessmentFormRequest extends FormRequest
{
    public function rules(): array
    {
        return [
            ...
            'schema.fields.*.type' => 'required|in:text,textarea,number,rating,select,radio,checkbox,date',
            'schema.fields.*.options' => 'sometimes|required_if:schema.fields.*.type,select,radio|array',
